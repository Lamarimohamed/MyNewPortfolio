...
export const TimelineSection = () => {
  ...
  const experiences = [
    ...
    },
    {
      ...
      location: 'Remote',
      description: 'Developed responsive web applications and collaborated with design teams to create exceptional user experiences. Mentored junior developers and implemented modern development practices.',
      technologies: ['HTML5', 'CSS3', 'Bootstrap', 'Next.js', 'JavaScript'],
      achievements: [
        'learning new technologies in the domain and applying them',
        'Implemented accessibility improvements across multiple projects'
      ]
    },
    {
    ...
    >
      <div className="max-w-4xl mx-auto">
        ...
        <div ref={timelineRef} className="relative">
          {isMobile ? (
            // Mobile Layout: EXACTLY like project cards
            <div className="grid grid-cols-1 gap-6 sm:gap-8" role="list" aria-label="Professional experience timeline">
              {experiences.map((exp, index) => (
                <article 
                  key={index}
                  className="glass-card p-6 group hover:scale-105 hover:shadow-2xl transition-all duration-500 w-full"
                  role="listitem"
                >
                  {/* Header */}
                  ...
                  {/* Meta Info */}
                  <div className="flex flex-col gap-2 my-4 text-chrome-medium text-sm">
